...
public class MonstersNMSInvokerV1_20_3 extends MonstersNMSInvoker {

    @Override
    public void dealExplosionDamage(Player player, int amount) {
        ServerPlayer serverPlayer = ((CraftPlayer) player).getHandle();
        serverPlayer.hurt(serverPlayer.damageSources().explosion(null), amount);
    }
    ...
    public void dealSonicBoomDamage(LivingEntity entity, int amount, Player source) {
        ...
        e.hurt(e.damageSources().sonicBoom(serverPlayer), amount);
    }
